...
const LEAVE_TYPES = [
  ...
  ["I'm on my period. Ha Ha Joke About Girl Parts I'm so Clever",                                         "Submit. Ensure That You Make it Literally Everyone Else's Problem."],
  ["I'm waiting for the Epstein Files",                                                                   "Submit. It's Not Happening."],
  ["I'm in a Highlander-Type Situation with all the other Abbys",                                         "Submit. Beware of Pirates."],
  ["Mothman Threatened to Leak our Chat History",                                                         "Submit. Keep it in Your Pants."],
  ...
  ["Angel consumed Tylenol when she was pregnant. A lot of Tylenol. Like, an Ungodly Amount of Tylenol.", "Submit. Stay away from Sonic the Hedgehog."],
